### damage calculation
## (5 + Base Damage) * (1 + strength/100) zaczynajac od konca
function main:player/stats/base_dmg_calc
function main:player/stats/additive_multiplier
function main:player/stats/multiplicative_multiplier
