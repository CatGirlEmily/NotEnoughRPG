...
execute if score @s zzz_mined.stone matches 1.. run scoreboard players add @s mining_xp 1
execute if score @s zzz_mined.stone matches 1.. run scoreboard players set @s zzz_mined.stone 0

execute if score @s zzz_mined.cobblestone matches 1.. run scoreboard players add @s mining_xp 1
...
execute if score @s zzz_mined.sand matches 1.. run scoreboard players add @s mining_xp 1
execute if score @s zzz_mined.sand matches 1.. run scoreboard players set @s zzz_mined.sand 0

execute if score @s zzz_mined.red_sand matches 1.. run scoreboard players add @s mining_xp 1
...
execute if score @s zzz_mined.blue_ice matches 1.. run scoreboard players add @s mining_xp 5
...
execute if score @s zzz_mined.obsidian matches 1.. run scoreboard players add @s mining_xp 7
...
execute if score @s zzz_mined.coal_ore matches 1.. run scoreboard players add @s mining_xp 4
execute if score @s zzz_mined.coal_ore matches 1.. run scoreboard players set @s zzz_mined.coal_ore 0

execute if score @s zzz_mined.deepslate_coal_ore matches 1.. run scoreboard players add @s mining_xp 8
execute if score @s zzz_mined.deepslate_coal_ore matches 1.. run scoreboard players set @s zzz_mined.deepslate_coal_ore 0

execute if score @s zzz_mined.iron_ore matches 1.. run scoreboard players add @s mining_xp 6
execute if score @s zzz_mined.iron_ore matches 1.. run scoreboard players set @s zzz_mined.iron_ore 0

execute if score @s zzz_mined.deepslate_iron_ore matches 1.. run scoreboard players add @s mining_xp 10
execute if score @s zzz_mined.deepslate_iron_ore matches 1.. run scoreboard players set @s zzz_mined.deepslate_iron_ore 0

execute if score @s zzz_mined.emerald_ore matches 1.. run scoreboard players add @s mining_xp 20
execute if score @s zzz_mined.emerald_ore matches 1.. run scoreboard players set @s zzz_mined.emerald_ore 0

execute if score @s zzz_mined.deepslate_emerald_ore matches 1.. run scoreboard players add @s mining_xp 24
...
execute if score @s zzz_mined.diamond_ore matches 1.. run scoreboard players add @s mining_xp 20
execute if score @s zzz_mined.diamond_ore matches 1.. run scoreboard players set @s zzz_mined.diamond_ore 0

execute if score @s zzz_mined.deepslate_diamond_ore matches 1.. run scoreboard players add @s mining_xp 24
...
execute if score @s zzz_mined.redstone_ore matches 1.. run scoreboard players add @s mining_xp 6
execute if score @s zzz_mined.redstone_ore matches 1.. run scoreboard players set @s zzz_mined.redstone_ore 0

execute if score @s zzz_mined.deepslate_redstone_ore matches 1.. run scoreboard players add @s mining_xp 10
...
execute if score @s zzz_mined.lapis_ore matches 1.. run scoreboard players add @s mining_xp 8
execute if score @s zzz_mined.lapis_ore matches 1.. run scoreboard players set @s zzz_mined.lapis_ore 0

execute if score @s zzz_mined.deepslate_lapis_ore matches 1.. run scoreboard players add @s mining_xp 12
