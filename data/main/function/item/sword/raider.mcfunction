...
scoreboard players set @s strength_weapon_bonus_rl 50
scoreboard players set @s strength_weapon_bonus 80
...
scoreboard players operation @s strength_weapon_bonus += @s raider_kills
