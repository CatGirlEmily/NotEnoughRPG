...
execute unless score @s mana matches 50.. run playsound minecraft:block.ender_chest.close master @s ~ ~ ~ 0.5 1
...
execute if score @s mana matches 50.. run playsound minecraft:entity.player.teleport master @s ~ ~ ~ 1 1
